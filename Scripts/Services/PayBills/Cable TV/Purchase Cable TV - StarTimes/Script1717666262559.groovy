...
WebUI.click(findTestObject('Page_BlueInTouch/div_StarTimes'))
...
WebUI.click(findTestObject('Page_BlueInTouch/li_nova_weekly'))
...
WebUI.verifyTextPresent('350.00', false)
