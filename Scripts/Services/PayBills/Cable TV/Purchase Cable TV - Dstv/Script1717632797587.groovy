...
WebUI.click(findTestObject('Object Repository/Page_BlueInTouch/div_DSTV'))
...
WebUI.click(findTestObject('Object Repository/Page_BlueInTouch/li_Padi'))
...
WebUI.verifyTextPresent('2150.00', false)
